...
class Lime(BlackBoxExplainer):
    ...
    interpretable_model
        ...
        <a href=
        "https://deel-ai.github.io/xplique/api/attributions/lime/#parameters-in-depth">
        Parameters In-Depth</a> ) for more information.
    similarity_kernel
    ...
    def explain(self,
        ...
        inputs
            ...
            documentation
            (<a href=
            "https://deel-ai.github.io/xplique/api/attributions/api_attributions/">
            API Description </a>).
        targets
