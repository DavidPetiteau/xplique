...
class KernelShap(Lime):
    ...
    map_to_interpret_space
        ...
        <a href=
        "https://deel-ai.github.io/xplique/api/attributions/kernel_shap/#parameters-in-depth">
        Parameters In-Depth</a> ) for more information and how to define it.
    nb_samples
    ...
    ref_value
        ...
        interpretable feature is set to 0.<br/>
